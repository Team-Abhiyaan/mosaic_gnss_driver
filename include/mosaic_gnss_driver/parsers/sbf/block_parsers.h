...
namespace sbf::block_parsers {
    /**
     * Parses messages of the Geodetic subtype, creates nav_msgs::NavSatFix and
    ...
    class Geodetic
    {
        ...
        const static sbf::u4 do_not_use_time =
            4294967295; // TODO static member of the block structure
